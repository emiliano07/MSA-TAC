...
print("Secuencias Iniciales:")
print("------------------------------------------------------")
secuencias = [S36]#S0,S1,S2,S3,S4,S5,S6,S7,S8,S9,S10,S11,S12,S13,S14,S15,S16,S17,S18,S19,S20,S21,S22,S23,S24,S25,S26,S27,S28,S29,S30,S31,S32,S33,S34,S35,S36]
secuenciasC = []#S0,S1,S2,S3,S4,S5,S6,S7,S8,S9,S10,S11,S12,S13]
secuenciasM = []#S14,S15,S16,S17,S18,S19,S20,S21,S22,S23,S24,S25]
secuenciasL = [S36]
escenario = 37
...
for sec in range(0,len(secuenciasC)):
    print("Escenario N° " + str(escenario))
    resultadosPD.append(executePD(secuenciasC[sec],10))
    resultadosGRASP.append(executeGrasp(secuenciasC[sec],10))
    escenario += 1
    print("---------------------")
for sec in range(0,len(secuenciasM)):
    print("Escenario N° " + str(escenario))
    resultadosPD.append(executePD(secuenciasM[sec],6))
    resultadosGRASP.append(executeGrasp(secuenciasM[sec],10))
    escenario += 1
    print("---------------------")
for sec in range(0,len(secuenciasL)):
    print("Escenario N° " + str(escenario))
    resultadosPD.append(executePD(secuenciasL[sec],3))
    resultadosGRASP.append(executeGrasp(secuenciasL[sec],6))
    escenario += 1
    print("---------------------")
print("------------------------------------------------------")
print("Alineamiento Final:")
